            ...
            <ReferralUpdateField<{ id?: string; label?: string }>
              ...
              render={({ field }) => (
                <SelectField
                  ...
                  isDirty={Boolean(specialtyField.value)}
          ...
          <div className="flex justify-center mt-2">
            <ReferralUpdateField<string | undefined>
              ...
              render={({ field: { value, onChange, ...field } }) => (
                <DatePicker
                  value={value}
                  isDirty={Boolean(startDateField.value)}
                  onChange={(date) => {
          ...
          <div className="flex justify-center mt-2">
            <ReferralUpdateField<string | undefined>
              ...
              render={({ field: { value, onChange, ...field } }) => (
                <DatePicker
                  value={value}
                  isDirty={Boolean(endDateField.value)}
                  onChange={(date) => {
                    const dateString = date
                      ? format(date, "yyyy-MM-dd")
                      : undefined;
            ...
            <ReferralUpdateField<{ id?: string }>
              ...
              render={({ field }) => (
                <SelectField
                  ...
                  isDirty={Boolean(priorityField.value)}
            ...
            <ReferralUpdateField<number | undefined>
              ...
              render={({ field: { onChange, value, ...field } }) => (
                <InputField
                  ...
                  isDirty={Boolean(numberOfVisitsField.value)}
