  ...
  return (
    <div className="flex flex-col items-center justify-center space-y-8">
      ...
      <div className="text-center space-y-2 mt-8">
        ...
        <p className="text-green-800 font-medium">We will keep recording until you click "End visit".</p>
      </div>
      ...
      <a href="#" className="text-green-600 hover:text-green-800 underline mt-4">
