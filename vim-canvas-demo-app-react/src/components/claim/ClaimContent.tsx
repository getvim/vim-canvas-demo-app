    ...
    <div className="w-full">
      {jsonMode ? (
        ...
        <>
          ...
          <EntitySectionContent>
            <EntityFieldContent>
              ...
              <EntityFieldReadonlyText
                text={
                  formatContentDate(
                    claim?.basicInformation?.claimDate?.toString()
                  ) ?? "--"
                }
              />
            </EntityFieldContent>
            <EntityFieldContent>
              ...
              <EntityFieldReadonlyText
                text={
                  formatContentDate(
                    claim?.basicInformation?.serviceDate?.toString()
                  ) ?? "--"
                }
              />
            </EntityFieldContent>
            ...
            <EntityFieldContent>
              ...
              <EntityFieldReadonlyText
                text={capitalizeFirstLetter(
                  claim?.basicInformation?.placeOfService?.description
                )}
              />
            </EntityFieldContent>
            <EntityFieldContent>
                ...
                <Fragment key={serviceLine?.procedureCode}>
                  ...
                  <EntitySectionContent>
                    ...
                    <EntityFieldContent>
                      ...
                      <EntityFieldReadonlyText
                        text={
                          serviceLine?.proceduresModifiers?.toString() ?? "--"
                        }
                      />
                    </EntityFieldContent>
                    <EntityFieldContent>
                      <EntityFieldTitle title="Diagnoses" />
                      <EntityFieldReadonlyList list={serviceLine?.diagnoses} />
                    </EntityFieldContent>
                  </EntitySectionContent>
                  <Separator className="mb-1" />
                </Fragment>
          ...
          <EntityFieldReadonlyList list={claim?.additionalDiagnoses} />
        </>
      )}
    </div>
  );
